                        ...
                        <select  class="form-select" name="id">
                            <option value="">Sélectionnez une fiche pour la supprimer </option>
                                ...
                                <?php foreach ($fiches as $fiche) { ?>
                                    <option value="<?php echo $fiche['pdf_id']; ?>" data-attribute="<?php echo $fiche['pdf_path']; ?>">
                                        <?php echo $fiche['pdf_content'] ?> - case n°<?php echo $fiche['pdf_case'] ?>
                                    </option>
                                <?php } ?>
                                <input id="inputPath" name="path" type="hidden" value="" />
                        </select>   
                        <script>
                                $("select").change(function(){
                                    var val = $(this).find("option:selected").val();
                                    var hidden = $(this).find("option:selected").attr("data-attribute");
                                    document.getElementById('inputPath').value = hidden;
